			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="动物品种" prop="dongwupinzhong">
						<el-input class="list_inp" v-model="form.dongwupinzhong" placeholder="动物品种"
							 type="text" 							:readonly="!isAdd||disabledForm.dongwupinzhong?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="12">
					<el-form-item label="动物性别" prop="dongwuxingbie">
						<el-input class="list_inp" v-model="form.dongwuxingbie" placeholder="动物性别"
							 type="text" 							:readonly="!isAdd||disabledForm.dongwuxingbie?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="12">
					<el-form-item label="救助站名称" prop="jiuzhuzhanmingcheng">
						<el-input class="list_inp" v-model="form.jiuzhuzhanmingcheng" placeholder="救助站名称"
							 type="text" 							:readonly="!isAdd||disabledForm.jiuzhuzhanmingcheng?true:false" />
					</el-form-item>
				</el-col>
