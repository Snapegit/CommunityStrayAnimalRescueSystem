			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="地点" prop="didian">
						<el-input class="list_inp" v-model="form.didian" placeholder="地点"
							 type="text" 							:readonly="!isAdd||disabledForm.didian?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="详情描述" prop="xiangqingmiaoshu">
						<editor class="list_editor" :value="form.xiangqingmiaoshu" placeholder="请输入详情描述" :readonly="!isAdd||disabledForm.xiangqingmiaoshu?true:false"
							@change="(e)=>editorChange(e,'xiangqingmiaoshu')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xiangqingmiaoshu = res.data.data.xiangqingmiaoshu.replace(reg,'../../../cl34219152/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='didian'){
					form.value.didian = row[x];
					disabledForm.value.didian = true;
					continue;
				}
				if(x=='tupian'){
				...
				if(x=='xiangqingmiaoshu'){
					form.value.xiangqingmiaoshu = row[x];
					disabledForm.value.xiangqingmiaoshu = true;
					continue;
				}
				if(x=='fabushijian'){
		...
		context?.$http({
			...
			if(json.hasOwnProperty('dianhuahaoma') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
