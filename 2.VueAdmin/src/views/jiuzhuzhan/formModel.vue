				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="规模" prop="guimo">
							<el-input class="list_inp" v-model="form.guimo" placeholder="规模"
								 type="text" 								:readonly="!isAdd||disabledForm.guimo?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='guimo'){
					form.value.guimo = row[x];
					disabledForm.value.guimo = true;
					continue;
				}
				if(x=='dizhi'){
