				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="详情描述" prop="xiangqingmiaoshu">
							<editor :value="form.xiangqingmiaoshu" placeholder="请输入详情描述" :readonly="!isAdd||disabledForm.xiangqingmiaoshu?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'xiangqingmiaoshu')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xiangqingmiaoshu = res.data.data.xiangqingmiaoshu?(res.data.data.xiangqingmiaoshu.replace(reg,'../../../cl34219152/file')):'';
